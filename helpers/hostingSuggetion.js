const suggesions = {
  ...
  Digital_ocean: {
    name: "Digital ocean",
    details:
      "Deploy faster & scale easier with an application server that saves your team time & money. Get started with fast, secure, and reliable cloud infrastructure solutions. Try for free. Manage W/ Teams. Simple API. 55 Sec. Deploy. Scale Quickly.",
  ...
  Interserver: {
    name: "interserver",
    details:
      "InterServer is a web hosting provider that seeks to create an all-in-one experience for its users. It has been providing hosting services for 21 ",
    link: "https://www.interserver.net",
  },
  Hostigator: {
    name: "Hostigator",
    details:
      "Leading Provider of Secure & Easy Website Hosting Service. Select Your Plan & Get Started! Choose From Shared Linux, Cloud, Vps and WP Hosting and Start Building your Website Today.",
